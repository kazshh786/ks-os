...
const EnvSchema = z.object({
  ...
  ,GOOGLE_MAIL_CLIENT_ID: z.string().optional()
  ,GOOGLE_MAIL_CLIENT_SECRET: z.string().optional()
  ,GOOGLE_MAIL_REDIRECT_URI: z.string().url().optional()
  ,ZOHO_MAIL_CLIENT_ID: z.string().optional()
  ,ZOHO_MAIL_CLIENT_SECRET: z.string().optional()
  ,ZOHO_MAIL_REDIRECT_URI: z.string().url().optional()
  ,MAILBOX_SYNC_ENABLED: z.enum(['true','false']).default('true').transform(v=>v==='true')
  ,MAILBOX_SYNC_INTERVAL_MS: z.coerce.number().int().min(15000).max(3600000).default(30000)
  ,MAILBOX_SYNC_BATCH_SIZE: z.coerce.number().int().min(1).max(50).default(10)
  ...
  ,EMAIL_OUTBOX_WORKER_SECRET: z.string().min(32).optional()
  ,AUTOMATION_WORKER_SECRET: z.string().min(32).optional()

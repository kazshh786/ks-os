...
export const PublicBookingLayout: React.FC = () => {
  return (
    <div className="relative flex min-h-dvh min-w-0 flex-col overflow-x-hidden bg-[#eef2f7] font-sans antialiased text-slate-950">
      ...
      <footer className="relative border-t border-slate-200/80 bg-white/75 px-5 py-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] backdrop-blur" aria-label="Booking security information">

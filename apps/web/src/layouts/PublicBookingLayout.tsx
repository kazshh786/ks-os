...
export const PublicBookingLayout: React.FC = () => {
  ...
  return (
    <div className="relative flex min-h-dvh flex-col overflow-x-hidden bg-[#eef2f7] font-sans antialiased text-slate-950">
      ...
      <main className="relative flex-1 px-3 py-3 sm:px-5 sm:py-4 lg:px-6">
        <Outlet />
      </main>

      <footer className="relative border-t border-slate-200/80 bg-white/75 px-5 py-3 backdrop-blur" aria-label="Request security information">

...
function PublicBookingSurface() {
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-slate-100 font-sans antialiased">
      ...
      <main className="relative flex-1 px-3 py-4 sm:px-5 sm:py-7 md:px-8 md:py-10"><BookingWizardPage /></main>
...
export const NotFoundPage: React.FC = () => {
  ...
  if (path === '/book' || /^\/book\/manage\/[0-9a-f-]+$/i.test(path)) return <PublicBookingSurface />;

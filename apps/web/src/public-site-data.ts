...
export const stackComparison = [
  ...
  ['Website design and build', '£3,000+ one-off', 'Included in the Growth launch package'],
  ['Hosting, maintenance and security', '£100+/mo', 'Included and managed'],
  ['Funnels and landing pages', '£150+/mo', 'Included'],
  ['Customer operations', '', ''],
  ['CRM and customer pipeline', '£400+/mo', 'Included'],
  ['Booking and team scheduling', '£50+/user/mo', 'Included'],
  ['Forms and lead capture', '£75+/mo', 'Included'],
  ['Email and SMS tools', '£200+/mo plus usage', 'Included; usage is billed transparently'],
  ['Workflow automation', '£200+/mo', 'Included'],
  ['Growth and reputation', '', ''],
  ['Reviews and reputation', '£200+/mo', 'Included'],
  ['Reporting and analytics', '£150+/mo', 'Included'],
  ['8 branded social-media posts', '£500+/mo', 'Included in Growth'],

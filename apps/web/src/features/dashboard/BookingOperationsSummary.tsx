...
export function BookingOperationsSummary() {
  ...
  return <section aria-labelledby="booking-operations-title" className="space-y-4">
    ...
    {error && <p role="alert" className="rounded-xl border border-rose-200 bg-rose-50 p-3 text-sm font-bold text-rose-800">{error} <button onClick={() => void load()} className="inline-flex min-h-11 items-center underline">Retry</button></p>}

...
describe('PublicBookingFlow', () => {
  ...
  it('completes the public mobile booking journey and renders a resilient confirmation', async () => {
    ...
    await waitFor(() => expect(Element.prototype.scrollIntoView).toHaveBeenCalledWith({ block: 'start', behavior: 'smooth' }));
    ...
    await user.type(screen.getByLabelText('Email address'), 'customer.with.a.long.address@example.com');

...
export function BlockTimeDialog({ open, timezone, staff, initialDate, onClose, onCreated }: {
  ...
  return <div className="fixed inset-0 z-50 flex items-end justify-center bg-slate-950/50 sm:items-center sm:p-6" onMouseDown={event => { if (event.target === event.currentTarget) onClose(); }}>

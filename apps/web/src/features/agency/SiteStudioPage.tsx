...
export function SiteStudioPage() {
  ...
  return <div className="space-y-5">
    ...
    <SearchIntelligencePanel siteReference={siteReference!} siteName={studio.site.tenantName || studio.site.displayName} canManage={canManage} pageTitlesByReference={pageTitlesByReference} blueprint={studio.blueprint} />

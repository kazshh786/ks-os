...
export default function OnboardingWizard({ onSuccessComplete }: OnboardingWizardProps) {
  ...
  const triggerProvisioning = async () => {
    ...
    try {
      // Retrieve caller session token for server authorization check
      ...
      if (!response.ok) {
        throw new Error(resData.error || 'Tenant provisioning execution failed.');
      }
      ...
      <div className={styles.wizardContent}>
        ...
        {step === 3 && (
          <div className={styles.stepContainer}>
            ...
            <div className={styles.inputGroup}>
              <label htmlFor="ownerPassword" className={styles.label}>Temporary Password</label>
              <input
                id="ownerPassword"
                type="password"
                className={styles.input}

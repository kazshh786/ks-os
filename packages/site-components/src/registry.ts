...
const SECTION_DEFAULTS: Record<SiteSectionType, {
  ...
  OPENING_HOURS: { classification: 'SUPPORTING', position: 'PAGE_BODY', weight: 'LOW', required: ['LOCATIONS', 'BOOKING'], optional: ['OPENING_HOURS'], assets: ['LOCATION_IMAGE'], slots: ['heading', 'locationReference', 'imageAssetReference'] },
...
const SECTION_PAGE_TYPES: Record<SiteSectionType, readonly SitePageType[]> = {
  ...
  BENEFITS: ['HOME', 'SERVICE_HUB', 'SERVICE_DETAIL', 'ABOUT', 'TEAM_HUB', 'TEAM_DETAIL', 'NEW_CLIENT_GUIDE', 'AFTERCARE_GUIDE', 'CONSULTATION_GUIDE', ...EDITORIAL_PAGE_TYPES],
  PROCESS: ['HOME', 'SERVICE_HUB', 'SERVICE_DETAIL', 'ABOUT', 'NEW_CLIENT_GUIDE', 'AFTERCARE_GUIDE', 'CONSULTATION_GUIDE', ...EDITORIAL_PAGE_TYPES],
  ...
  RICH_TEXT: ['SERVICE_HUB', 'SERVICE_DETAIL', 'ABOUT', 'TEAM_HUB', 'TEAM_DETAIL', 'CONTACT', 'FAQ', 'POLICIES', 'RESULTS', 'NEW_CLIENT_GUIDE', 'AFTERCARE_GUIDE', 'CONSULTATION_GUIDE', ...EDITORIAL_PAGE_TYPES],
};
